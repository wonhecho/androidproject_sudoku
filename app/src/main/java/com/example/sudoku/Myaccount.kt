...
class Myaccount : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater!!.inflate(R.layout.fragment_myaccount, container, false)
        ...
        user?.let {
            ...
            val uid = user.uid
            view.userinfo.setText("이름 : ${name}")
            view.userinfo2.setText("이메일 : ${email}")
            view.logout.setOnClickListener{
                var intent = Intent(getActivity(),splash::class.java)
